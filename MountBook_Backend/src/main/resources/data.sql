...
INSERT INTO structure (id, name, address, email, web_site, description, max_num_bed, price, altitude, longitude, latitude, open, close, telephone_number, type) VALUES (1, 'il rifugio della motagna',	'via in cima alla montegna più alta',	'montainrefuge@email.com',		'www.rifugio.it',	'un rifugio montano alla vecchia maniera con tutti i confort moderni',	20, 21.60, 1896, 145.654, -56.9822, '2022-01-01', '2022-05-30', 1123456789,0);
INSERT INTO structure (id, name, address, email, web_site, description, max_num_bed, price, altitude, longitude, latitude, open, close, telephone_number, type) VALUES (2, 'rifugio Calmamente',		'via poco trafficata',					'rifugiocalmamente@email.com',	'www.rifugio.it',	'un luogo di pace e serenità lontano dallo stress cittadino',			15, 35.80, 2068, -96.214, 65.985, '2022-04-01', '2022-09-30', 1123456789,0);
INSERT INTO structure (id, name, address, email, web_site, description, max_num_bed, price, altitude, longitude, latitude, open, close, telephone_number, type) VALUES (3, 'lake resort',				'corso intorno al lago',				'lakeshelter@email.com',		'www.rifugio.it',	'un rifugio a due passi dal lago',										40, 40.10, 1569, 176.369, 55.5486, '2022-01-01', '2022-12-31', 1123456789,0);
